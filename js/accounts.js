...
function mobile_otp(mobile_attributes){
  const url = 'https://api.youthstring.in/send_mobile_user_details/';
...
function get_user_name(user_id_json){
  const url = 'https://api.youthstring.in/get_user_name/';
...
function update_name_api(user_data){
  const url = 'https://api.youthstring.in/name_update/';
