...
function order_creation(){
  ...
  .then(data=>{
    ...
    if ((google_user_id != null)&&(mobile_user_id==null) ){
      console.log("google_user")
      var orderID=data.order_id;
      const order_detail = {"order_id":String(orderID)}
      try{
        
      
      send_email(order_detail)
      .then(data=>{
...
function order_api(user_data){
  const url = 'https://api.youthstring.in/order_creation/';
...
function send_email(user_data){
  const url = 'https://api.youthstring.in/invoice_send_mail/';
...
function googleAPIData(){
  ...
  var apiUrl = 'https://api.youthstring.in/googlelogin/' + String(modifiedGoogleCode);
