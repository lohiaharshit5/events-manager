...
// Do something with the user_id
  ...
  if (mobile_user_id!=null){
    const apiUrl = 'https://api.youthstring.in/user_order_count/'; // Replace with your API URL
...
function event_data(order_id){
    const url = 'https://api.youthstring.in/invoice_data_send/';
  ...
  function make_invoice(invoiceJson){
    const url = 'https://api.youthstring.in/invoice_download/';
    const requestOptions = {
    method: 'POST',
    headers: {
      'Authorization': 'ghsJJDGEBBDC%^&C%^527272---etgdbRandom',
